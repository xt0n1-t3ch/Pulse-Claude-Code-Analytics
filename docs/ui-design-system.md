...
- Dark and light themes keep navigation, surfaces, borders, controls, focus, and ordinary copy neutral and low-saturation.
...
- The shared provider strip remains exactly centered and uses the available
  desktop width instead of leaving a narrow card island. At narrow widths it
  scrolls inline without changing analytics or Discord provider ownership.
