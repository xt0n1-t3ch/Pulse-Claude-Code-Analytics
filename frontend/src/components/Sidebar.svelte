<script lang="ts">
  ...
  const navItems = [
    ...
    { id: "sessions", icon: "messages", title: "Sessions" },
    { id: "context", icon: "context", title: "Context" },
    { id: "costs", icon: "dollar", title: "Costs" },
    { id: "reports", icon: "reports", title: "Reports" },
    { id: "discord", icon: "discord", title: "Discord" },
  ];
...
<aside class="sidebar">
  <div class="sidebar-logo" title="Pulse" aria-label="Pulse">
    ...
    <span class="sidebar-wordmark">Pulse</span>
  </div>
    ...
    {#each navItems as item}
      ...
      >
        ...
        {:else if item.icon === "reports"}
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="14" x2="15" y2="14"/><line x1="9" y1="18" x2="15" y2="18"/><line x1="9" y1="10" x2="10" y2="10"/></svg>
...
<style>
  ...
  @media (max-width: 900px) {
    ...
    .sidebar-wordmark, .nav-label { display: none; }
    .nav-btn { width: 46px; justify-content: center; padding: 0; margin-inline: auto; }
    .nav-btn.active::before { position: absolute; left: 0; margin: 0; }
  }
</style>
